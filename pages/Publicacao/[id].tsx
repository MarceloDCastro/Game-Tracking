...
import { Accordion, AccordionDetails, AccordionSummary, Avatar, Box, Button, Stack, Typography } from '@mui/material';
import { Message, PhotoCamera, Visibility, ExpandMore } from '@mui/icons-material';
